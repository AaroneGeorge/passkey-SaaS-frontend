  ...
  return (
    <nav className="w-full flex py-6 justify-between items-center navbar">
      ...
      <ul className="list-none sm:flex hidden justify-end items-center flex-1">
        <li
          className="font-poppins font-normal cursor-pointer text-[16px] text-dimWhite hover:text-white mr-10"
        >
          <a href="/">Home</a>
        </li>
        <li
          className="font-poppins font-normal cursor-pointer text-[16px] text-dimWhite hover:text-white mr-10"
        >
          <a href="https://www.google.com" target="_blank" rel="noopener noreferrer">Documentation</a>
        </li>
        <li
          className="font-poppins font-normal cursor-pointer text-[16px] text-dimWhite hover:text-white mr-10"
        >
      ...
      <div className="sm:hidden flex flex-1 justify-end items-center">
        ...
        >
          <ul className="list-none flex justify-end items-start flex-1 flex-col">
            <li
              className="font-poppins font-medium cursor-pointer text-[16px] text-dimWhite hover:text-white mb-4"
            >
              <a href="/">Home</a>
            </li>
            <li
